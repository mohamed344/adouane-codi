...
const words: Record<string, { en: string; ar: string }> = {
  ...
  "ni": { en: "nor", ar: "ولا" },
  "et": { en: "and", ar: "و" },
  // Common consumer/tech products (EN/AR → FR search support)
  "imprimante": { en: "printer", ar: "طابعة" },
  "imprimantes": { en: "printers", ar: "طابعات" },
  "ordinateur": { en: "computer", ar: "حاسوب" },
  "ordinateurs": { en: "computers", ar: "حواسيب" },
  "telephone": { en: "phone", ar: "هاتف" },
  "telephones": { en: "phones", ar: "هواتف" },
  "portables": { en: "laptops", ar: "محمولة" },
  "television": { en: "television", ar: "تلفاز" },
  "televiseur": { en: "TV set", ar: "جهاز تلفاز" },
  "ecran": { en: "screen", ar: "شاشة" },
  "ecrans": { en: "screens", ar: "شاشات" },
  "clavier": { en: "keyboard", ar: "لوحة مفاتيح" },
  "souris": { en: "mouse", ar: "فأرة" },
  "disque": { en: "disk", ar: "قرص" },
  "camionnette": { en: "van", ar: "شاحنة صغيرة" },
  "moto": { en: "motorcycle", ar: "دراجة نارية" },
  "motocyclette": { en: "motorcycle", ar: "دراجة نارية" },
  "velo": { en: "bicycle", ar: "دراجة" },
  "bicyclette": { en: "bicycle", ar: "دراجة هوائية" },
  "refrigerateur": { en: "refrigerator", ar: "ثلاجة" },
  "congelateur": { en: "freezer", ar: "مجمد" },
  "climatiseur": { en: "air conditioner", ar: "مكيف" },
  "ventilateur": { en: "fan", ar: "مروحة" },
  "chauffage": { en: "heater", ar: "مدفأة" },
  "lave-linge": { en: "washing machine", ar: "غسالة" },
  "lave-vaisselle": { en: "dishwasher", ar: "غسالة صحون" },
  "aspirateur": { en: "vacuum cleaner", ar: "مكنسة كهربائية" },
  "four": { en: "oven", ar: "فرن" },
  "micro-ondes": { en: "microwave", ar: "ميكروويف" },
  "chaussure": { en: "shoe", ar: "حذاء" },
  "vetement": { en: "garment", ar: "ملبس" },
  "pantalon": { en: "pants", ar: "بنطلون" },
  "chemise": { en: "shirt", ar: "قميص" },
  "robe": { en: "dress", ar: "فستان" },
  "jouets": { en: "toys", ar: "ألعاب" },
  "jouet": { en: "toy", ar: "لعبة" },
  "montre": { en: "watch", ar: "ساعة" },
  "montres": { en: "watches", ar: "ساعات" },
  "bijoux": { en: "jewelry", ar: "مجوهرات" },
  "lunettes": { en: "glasses", ar: "نظارات" },
  "meuble": { en: "furniture", ar: "أثاث" },
  "meubles": { en: "furniture", ar: "أثاث" },
  "chaise": { en: "chair", ar: "كرسي" },
  "table": { en: "table", ar: "طاولة" },
  "lit": { en: "bed", ar: "سرير" },
  "pneu": { en: "tire", ar: "إطار" },
  "pneus": { en: "tires", ar: "إطارات" },
  "parfumerie": { en: "perfumery", ar: "عطور" },
  "cosmetique": { en: "cosmetic", ar: "تجميلي" },
  "dentifrice": { en: "toothpaste", ar: "معجون أسنان" },
  "shampoing": { en: "shampoo", ar: "شامبو" },
  "panneau": { en: "panel", ar: "لوحة" },
  "panneaux": { en: "panels", ar: "لوحات" },
  "solaire": { en: "solar", ar: "شمسي" },
  "solaires": { en: "solar", ar: "شمسية" },
  "serrure": { en: "lock", ar: "قفل" },
  "serrures": { en: "locks", ar: "أقفال" },
  "clou": { en: "nail", ar: "مسمار" },
};
